  ...
  return (
    <div className="space-y-16">
          ...
          {investmentSteps.map((step, index) => (
            ...
            >
              <div className="bg-white dark:bg-secondary-800 p-6 rounded-lg shadow-md text-center">
                ...
                <div className="text-primary-600 text-2xl font-bold mb-4">
                  Step {index + 1}
                </div>
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <div>
                      ...
                      <p className="font-semibold">
                        ${property.price?.usd?.toLocaleString() ?? "N/A"}
                      </p>
                      <p className="text-sm text-primary-600">
                        {property.price?.eth ?? "N/A"} ETH
                      </p>
                    </div>
      ...
      <section className="bg-secondary-50 dark:bg-secondary-900 pt-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why Choose BestCity</h2>
            <p className="text-secondary-600 dark:text-secondary-300">
      ...
      <div className="container bg-white dark:bg-secondary-900 py-24">
        ...
        {loading && (
          <div className="text-center py-12">
            <div className="inline-block h-8 w-8 animate-spin rounded-full border-4 border-primary-600 border-r-transparent" />
            <p className="mt-4 text-secondary-600">Loading articles...</p>
          </div>
        )}
